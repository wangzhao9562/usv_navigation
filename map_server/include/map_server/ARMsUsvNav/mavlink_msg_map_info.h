...
#define MAVLINK_MSG_ID_MAP_INFO_LEN 4147488
#define MAVLINK_MSG_ID_MAP_INFO_MIN_LEN 4147488
#define MAVLINK_MSG_ID_0_LEN 4147488
#define MAVLINK_MSG_ID_0_MIN_LEN 4147488

#define MAVLINK_MSG_ID_MAP_INFO_CRC 129
#define MAVLINK_MSG_ID_0_CRC 129
...
#define MAVLINK_MESSAGE_INFO_MAP_INFO { \
    ...
    "MAP_INFO", \
    10, \
    {  { "map_name", NULL, MAVLINK_TYPE_UINT8_T, 256, 4147232, offsetof(mavlink_map_info_t, map_name) }, \
         { "map_name_len", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_map_info_t, map_name_len) }, \
         { "occupancy_grid", NULL, MAVLINK_TYPE_UINT16_T, 2073600, 32, offsetof(mavlink_map_info_t, occupancy_grid) }, \
...
static inline uint16_t mavlink_msg_map_info_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const uint8_t *map_name, uint32_t map_name_len, const uint16_t *occupancy_grid, uint32_t map_width, uint32_t map_height, uint32_t origin_x, uint32_t origin_y, uint32_t x_in_last_map, uint32_t y_in_last_map, float resolution)
{
    ...
    _mav_put_uint16_t_array(buf, 32, occupancy_grid, 2073600);
    _mav_put_uint8_t_array(buf, 4147232, map_name, 256);
...
static inline void mavlink_msg_map_info_send(mavlink_channel_t chan, const uint8_t *map_name, uint32_t map_name_len, const uint16_t *occupancy_grid, uint32_t map_width, uint32_t map_height, uint32_t origin_x, uint32_t origin_y, uint32_t x_in_last_map, uint32_t y_in_last_map, float resolution)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAP_INFO_LEN];
    _mav_put_uint32_t(buf, 0, map_name_len);
 ...
 */
static inline void mavlink_msg_map_info_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const uint8_t *map_name, uint32_t map_name_len, const uint16_t *occupancy_grid, uint32_t map_width, uint32_t map_height, uint32_t origin_x, uint32_t origin_y, uint32_t x_in_last_map, uint32_t y_in_last_map, float resolution)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint8_t_array(msg, map_name, 256,  4147232);
}
...
{
    return _MAV_RETURN_uint16_t_array(msg, occupancy_grid, 2073600,  32);
}
