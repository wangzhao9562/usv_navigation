...
typedef struct __mavlink_map_info_t {
 ...
 uint16_t occupancy_grid[2073600]; /*<  Value of occupancy gird*/
}) mavlink_map_info_t;

#define MAVLINK_MSG_ID_MAP_INFO_LEN 4147228
#define MAVLINK_MSG_ID_MAP_INFO_MIN_LEN 4147228
#define MAVLINK_MSG_ID_0_LEN 4147228
#define MAVLINK_MSG_ID_0_MIN_LEN 4147228

#define MAVLINK_MSG_ID_MAP_INFO_CRC 193
#define MAVLINK_MSG_ID_0_CRC 193
...
#define MAVLINK_MESSAGE_INFO_MAP_INFO { \
    ...
    "MAP_INFO", \
    8, \
    {  { "occupancy_grid", NULL, MAVLINK_TYPE_UINT16_T, 2073600, 28, offsetof(mavlink_map_info_t, occupancy_grid) }, \
         { "map_width", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_map_info_t, map_width) }, \
         { "map_height", NULL, MAVLINK_TYPE_UINT32_T, 0, 4, offsetof(mavlink_map_info_t, map_height) }, \
         { "origin_x", NULL, MAVLINK_TYPE_UINT32_T, 0, 8, offsetof(mavlink_map_info_t, origin_x) }, \
         { "origin_y", NULL, MAVLINK_TYPE_UINT32_T, 0, 12, offsetof(mavlink_map_info_t, origin_y) }, \
         { "x_in_last_map", NULL, MAVLINK_TYPE_UINT32_T, 0, 16, offsetof(mavlink_map_info_t, x_in_last_map) }, \
         { "y_in_last_map", NULL, MAVLINK_TYPE_UINT32_T, 0, 20, offsetof(mavlink_map_info_t, y_in_last_map) }, \
         { "resolution", NULL, MAVLINK_TYPE_FLOAT, 0, 24, offsetof(mavlink_map_info_t, resolution) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_MAP_INFO { \
...
static inline uint16_t mavlink_msg_map_info_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               const uint16_t *occupancy_grid, uint32_t map_width, uint32_t map_height, uint32_t origin_x, uint32_t origin_y, uint32_t x_in_last_map, uint32_t y_in_last_map, float resolution)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAP_INFO_LEN];
    _mav_put_uint32_t(buf, 0, map_width);
    _mav_put_uint32_t(buf, 4, map_height);
    _mav_put_uint32_t(buf, 8, origin_x);
    _mav_put_uint32_t(buf, 12, origin_y);
    _mav_put_uint32_t(buf, 16, x_in_last_map);
    _mav_put_uint32_t(buf, 20, y_in_last_map);
    _mav_put_float(buf, 24, resolution);
    _mav_put_uint16_t_array(buf, 28, occupancy_grid, 2073600);
    ...
    mav_array_memcpy(packet.occupancy_grid, occupancy_grid, sizeof(uint16_t)*2073600);
...
{
    return mavlink_msg_map_info_pack(system_id, component_id, msg, map_info->occupancy_grid, map_info->map_width, map_info->map_height, map_info->origin_x, map_info->origin_y, map_info->x_in_last_map, map_info->y_in_last_map, map_info->resolution);
}
...
{
    return mavlink_msg_map_info_pack_chan(system_id, component_id, chan, msg, map_info->occupancy_grid, map_info->map_width, map_info->map_height, map_info->origin_x, map_info->origin_y, map_info->x_in_last_map, map_info->y_in_last_map, map_info->resolution);
}
...
static inline void mavlink_msg_map_info_send(mavlink_channel_t chan, const uint16_t *occupancy_grid, uint32_t map_width, uint32_t map_height, uint32_t origin_x, uint32_t origin_y, uint32_t x_in_last_map, uint32_t y_in_last_map, float resolution)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_MAP_INFO_LEN];
    _mav_put_uint32_t(buf, 0, map_width);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_map_info_send(chan, map_info->occupancy_grid, map_info->map_width, map_info->map_height, map_info->origin_x, map_info->origin_y, map_info->x_in_last_map, map_info->y_in_last_map, map_info->resolution);
#else
 ...
 */
static inline void mavlink_msg_map_info_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  const uint16_t *occupancy_grid, uint32_t map_width, uint32_t map_height, uint32_t origin_x, uint32_t origin_y, uint32_t x_in_last_map, uint32_t y_in_last_map, float resolution)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_map_info_get_occupancy_grid(const mavlink_message_t* msg, uint16_t *occupancy_grid)
{
    return _MAV_RETURN_uint16_t_array(msg, occupancy_grid, 2073600,  28);
}
